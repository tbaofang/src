...
// Version as text:
#define MRPT_OPENCV_VERSION      "3.1.0"

// Version as hexadecimal number: eg. 1.0.0 -> 0x100
#define MRPT_OPENCV_VERSION_NUM  0x310
